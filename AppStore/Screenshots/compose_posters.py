...
POSTERS = [
    {
        ...
        "kicker": "LESSON",
        "title": ("Today's kolam", "is a lesson"),
        "sub": "Tamil names, pulli count, Learn Step-by-Step.",
    ...
    },
    {
        ...
        "bg": "bg-02-learn.png",
        "kicker": "LEARN",
        "title": ("Trace pulli", "stroke by stroke"),
        "sub": "Tamil kolam lessons on a kind grid.",
    ...
    {
        "file": "03-trace.png",
        "capture": "03-explore.png",
        "bg": "bg-03-trace.png",
        "kicker": "COURSE",
        "title": ("Find the next", "kolam lesson"),
        "sub": "Pulli, sikku, and festival courtyards.",
    ...
    {
        "file": "04-create.png",
        "capture": "04-detail.png",
        "bg": "bg-04-create.png",
        "kicker": "WHY",
        "title": ("Why this kolam", "is drawn"),
        "sub": "Tamil name, pulli count, Learn Step-by-Step.",
        "title_colors": [WHITE, IVORY, GOLD],
